...
class Thread(Table, tablename="thread"):
    id = Serial(
        null=False,
        primary_key=True,
        unique=False,
...
async def forwards():
    ...
    manager.add_table("TaskTest", tablename="task_test")

    manager.add_table("Test", tablename="test")

    manager.add_table("ThreadUser", tablename="thread_user")

    manager.add_table("User", tablename="piccolo_user")

    manager.add_table("Formation", tablename="formation")

    manager.add_table("Grade", tablename="grade")

    manager.add_table("TaskUser", tablename="task_user")

    manager.add_table("Task", tablename="task")

    manager.add_table("Matter", tablename="matter")

    manager.add_table("Thread", tablename="thread")
    ...
    manager.add_column(
        table_class_name="TaskTest",
        tablename="task_test",
        column_name="test_id_id",
        db_column_name="test_id_id",
        column_class_name="ForeignKey",
        column_class=ForeignKey,
        params={
            "references": Test,
    ...
    manager.add_column(
        table_class_name="Formation",
        tablename="formation",
        column_name="eqf_level",
        db_column_name="eqf_level",
        column_class_name="Integer",
        column_class=Integer,
        params={
            "default": 0,
    ...
    manager.add_column(
        ...
        params={
            ...
            "index_method": IndexMethod.btree,
            "choices": Enum(
                "Type", {"homework": "homework", "test": "test", "info": "info"}
            ),
            "db_column_name": None,
            "secret": False,
        },
